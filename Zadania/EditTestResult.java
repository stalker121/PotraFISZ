...
public class TestResult extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(percentage>50){
            ...
            catPic.setImageResource(R.drawable.good_result);//NALEŻY ZMIENIĆ
            percentLabel.setTextColor(getResources().getColor(R.color.green));//NALEŻY ZMIENIĆ
        }else{
            congratsLabel.setText("Popracuj więcej, aby uzyskać lepszy wynik!");
            catPic.setImageResource(R.drawable.bad_result_cat);//NALEŻY ZMIENIĆ
            percentLabel.setTextColor(getResources().getColor(R.color.red));//NALEŻY ZMIENIĆ
        }
